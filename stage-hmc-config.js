window.quizConfig = {
  ...
  nodes: {
    ...
    qA5L2_intro_submitter: {
      ...
      textHtml:
        "<span style='font-size: 16px;'>Consistent monitoring, 7 days a week. Testing schedules managed by Soberlink.</span><br/><span style='font-size: 12px; font-weight: bold;'>Plans start at $175<span style='font-size: 10px;'>/mo</span></span>",
      imageUrl:
    ...
    qA5L1_intro_submitter: {
      ...
      textHtml:
        "<span style='font-size: 16px;'>This plan allows you to test only on days that you need to show proof of sobriety.</span><br/><span style='font-size: 12px; font-weight: bold;'>Plans start at $135<span style='font-size: 10px;'>/mo</span></span>",
      imageUrl:
        "https://cdn.prod.website-files.com/5f001b69b01d2658098e3f5c/69a8913be2c8175724ce3d4f_Level-1-Photo%201.avif",
      ...
      options: [
        {
          value: "twentyEnough",
          labelHtml:
            "20 testing days per month is enough. <span class='u-normal'>Extra days at $15 each.</span><br/><span style='font-size: 12px;'>Plans start at $135<span style='font-size: 10px;'>/mo</span></span>",
          icon: {
    ...
    qA3_share_contacts_submitter: {
      ...
      options: [
        ...
        },
        {
          ...
          labelHtml:
            "<span class='u-normal'>I need my</span> results shared <span class='u-normal'>with</span> more than one Contact.<span class='u-normal' style='font-size: 12px;'>Plans start at $215<span style='font-size: 10px;'>/mo</span></span>",
          icon: {
            url: "https://cdn.prod.website-files.com/5f001b69b01d2658098e3f5c/698131dd9b14c609f0ac6f6f_Two%20People%20%2B.png",
            alt: "two people",
          },
